...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "/usr/local/Cellar/ffmpeg/5.1.2/bin";//ffmpeg的安装位置
    String video_path = "~/Desktop/test1.avi";
    String mp4_name = "test1.mp4";
    String mp4folder_path = "~/Desktop/Movies/test1/";
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String mp4_name = "test1.mp4";
        //转换后mp4文件的路径
        String mp4_path = "~/Desktop/Movies/test1/";
        //创建工具类对象
